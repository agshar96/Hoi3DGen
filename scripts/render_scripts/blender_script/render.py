...
def init_nodes(save_depth=False, save_normal=False, save_albedo=False, save_mist=False):
    ...
    # safer than hardcoding "View Layer"
    layer = bpy.context.view_layer
    layer.use_pass_z = save_depth
    layer.use_pass_normal = save_normal
    layer.use_pass_diffuse_color = save_albedo
    layer.use_pass_mist = save_mist
...
def init_lighting_old():
    ...
    default_light.data.energy = 20000 # 1000
    ...
    top_light.data.energy = 20000 # 10000
    top_light.location = (0, 0, 7)
    top_light.scale = (100, 100, 100)
    
    # create bottom light
    bottom_light = bpy.data.objects.new("Bottom_Light", bpy.data.lights.new("Bottom_Light", type="AREA"))
    bpy.context.collection.objects.link(bottom_light)
    bottom_light.data.energy = 20000 # 1000
    bottom_light.location = (0, 0, -7)
...
def init_lighting_clip():
    ...
    # Helper function to create and link lights
    def create_light(name, type, location, energy, scale=(1, 1, 1), rotation=(0, 0, 0)):
    ...
    # Surround lighting setup
    lights['front_light'] = create_light("Front_Light", "AREA", (0, -5, 3), 800, scale=(5, 5, 5))
    lights['back_light'] = create_light("Back_Light", "AREA", (0, 5, 3), 600, scale=(5, 5, 5), rotation=(0, 0, 3.1416))
    lights['left_light'] = create_light("Left_Light", "AREA", (-5, 0, 3), 600, scale=(5, 5, 5), rotation=(0, 0, 1.5708))
    lights['right_light'] = create_light("Right_Light", "AREA", (5, 0, 3), 600, scale=(5, 5, 5), rotation=(0, 0, -1.5708))
    lights['top_light'] = create_light("Top_Light", "AREA", (0, 0, 8), 1000, scale=(10, 10, 10))
    lights['bottom_light'] = create_light("Bottom_Light", "AREA", (0, 0, -5), 300, scale=(5, 5, 5), rotation=(3.1416, 0, 0))
...
def main(arg):
    ...
    if arg.save_mesh:
        ...
        # export glb mesh + textures
        bpy.ops.export_scene.gltf(
            filepath=os.path.join(arg.output_folder, "mesh.glb"),
            export_format='GLB',
        ...
        filepath=os.path.join(arg.output_folder, "mesh.obj"),
